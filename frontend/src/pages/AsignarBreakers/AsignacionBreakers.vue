            ...
            <template v-slot:body="props">
              <q-tr :props="props">
                ...
                <q-td key="botones" :props="props">
                  <q-btn color="primary" label="Asignar" size="sm" @click="irAsignacion(props.row.codigo)"/>
                </q-td>
              </q-tr>
            </template>
...
export default {
  ...
  methods: {
    irAsignacion (id) {
      this.$router.push({ path: `/breakers/${id}/asignacion` })
    }
  }
}
</script>
